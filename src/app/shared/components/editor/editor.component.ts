...
export class EditorComponent implements OnInit, ControlValueAccessor {
    ...
    onReady(editor: any) {
        ...
        if (this.readOnly) {
            ...
            // console.log(
            // 'Componente ' + this._name + ': onReady:' + editor.id + ' editor.ui.view.toolbar.items.get(0) ─> ',
            //     editor.ui.view.toolbar.items.get(0)
            // );
            console.log(
                // 'Componente ' + this._name + ': onReady:' + editor.id + ' editor.ui.view.toolbar.items.get(0).isEnabled ─> ',
                editor.ui.view.toolbar.items.get(0).isEnabled
            );
        ...
        // console.log(
        //     'Componente ' + this._name + ': onReady:' + editor.id + ' editor.ui.getEditableElement().parentElement ─> ',
